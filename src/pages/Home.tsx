...
export default function Home() {
  return (
    <div className="min-h-screen w-full bg-[#FAFAF8] flex flex-col">
            ...
            {buttons.map((button, index) => {
              ...
              const cardContent = (
                <div className="flex flex-col items-center justify-center h-full py-10 px-5">
                  ...
                  <h3 className="text-xl font-semibold text-[#1A1A1A] text-center">
                    {button.title}
                  </h3>
                  <p className="text-sm text-[#8B7355] text-center mt-1.5">
                    {button.description}
                  </p>
                </div>
              );
      ...
      <footer className="bg-white border-t border-[#E8E4DE] px-6 py-3">
        <div className="max-w-5xl mx-auto flex items-center justify-end gap-x-4 gap-y-1 flex-wrap text-[10px] text-[#8B7355]">
